...
class simple_html_dom_node {
    ...
    function last_child() {
        ...
        if (($count=count($this->children))>0) return 
...
PREG_SET_ORDER);
        ...
        foreach ($matches as $m) {
            ...
            list($tag, $key, $val, $exp, $no_key) = array($m[1], null, 
null, '=', false);
...
'meta'=>1, 'link'=>1, 'hr'=>1, 'base'=>1, 'embed'=>1, 'spacer'=>1);
    ...
    protected $block_tags = array('root'=>1, 'body'=>1, 'form'=>1, 
...
strtolower($this->parent->tag)!==$tag_lower)
                    ...
                    if (strtolower($this->parent->tag)!==$tag_lower) {
                        ...
                        $this->parent = $org_parent; // restore origonal 
parent
...
'___noise___'.$text[$pos+11].$text[$pos+12].$text[$pos+13];
            ...
            if (isset($this->noise[$key]))
                ...
                $text = substr($text, 0, 
$pos).$this->noise[$key].substr($text, $pos+14);
...
$idx);}
    ...
    function getElementsByTagName($name, $idx=-1) {return 
$this->find($name, $idx);}
